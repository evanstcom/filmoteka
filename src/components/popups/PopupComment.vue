                ...
                <div class="bg-white px-4 pb-4 pt-2">
                  ...
                  <div class="flex flex-col gap-2 my-2 items-center">
                    ...
                    >
                      ...
                      <SliderThumb
                          class="block w-6 h-6 bg-gray-200 rounded-full shadow-sm focus:outline-none border-2"
                          aria-label="Volume"
                          :class="vote[0] < 4 ? 'border-red-400' : vote[0] < 7 ? 'border-gray-400' : vote[0] > 8 ? 'border-yellow-400' : 'border-green-400'"
                      />
                    </SliderRoot>
                  </div>
