        ...
        <div class="flex min-h-full justify-center items-center p-4 text-center sm:items-center backdrop-blur-sm">
          ...
          >
            <DialogPanel
              ...
              <form class="space-y-1 bg-gray-100" action="#" method="POST">
                <div class="bg-gray-100 px-4 pb-4 pt-2">
                  ...
                  <div class="mt-2">
                    <input v-model="name" type="text" name="name" id="name" autocomplete="name" required
                           class="w-full px-3 rounded-md bg-gray-100 py-1.5 text-base outline outline-1 outline-gray-400 -outline-offset-1 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-orange-600 sm:text-sm/6"/>
                  </div>
                </div>
                <div class="bg-gray-100 px-4 pb-4 pt-2">
                  <button
