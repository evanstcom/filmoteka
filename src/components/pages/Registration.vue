  ...
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm relative">
      <img class="mx-auto h-16 w-auto rounded-full border border-orange-600" src="/img/icons/192x192.png"
           alt="Your Company"/>
      <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight">Регистрация</h2>
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model="password" type="password" name="password" id="password" autocomplete="current-password"
                   required=""
                   class="block w-full rounded-md bg-gray-100 px-3 py-1.5 text-base outline outline-1 outline-gray-900 -outline-offset-1 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-orange-600 sm:text-sm/6 autofill:bg-gray-900"/>
          </div>
        </div>
